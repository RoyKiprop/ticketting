defmodule Ticketting.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Ticketting.Repo)
  ...
  def create_changeset(changeset, attrs, opts \\ []) do
    changeset
    |> cast(attrs, [:email, :super_admin, :active, :hashed_password, :role_id, :name])
    |> validate_email(opts)
  end
  ...
  """
  def valid_password?(%Ticketting.Accounts.User{hashed_password: hashed_password}, password)
