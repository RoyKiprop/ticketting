defmodule Ticketting.Accounts do
  @moduledoc """
  ...
  alias Ticketting.Accounts.{User, UserToken, UserNotifier}
  ...
  def get_role_permissions_by_role_id(role_id) do
    Repo.all(from rp in RolePermission, where: rp.role_id == ^role_id, select: rp.permission_id)
  end
