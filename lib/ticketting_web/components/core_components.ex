defmodule TickettingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TickettingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TickettingWeb.Gettext, "errors", msg, opts)
    end
  end
