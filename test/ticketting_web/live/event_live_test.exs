defmodule TickettingWeb.EventLiveTest do
  use TickettingWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ticketting.EventsFixtures

  @create_attrs %{name: "some name", date: "2024-12-01T12:48:00", description: "some description", location: "some location", image: "some image", start_time: "14:00", end_time: "14:00", is_active: true, slug: "some slug"}
  @update_attrs %{name: "some updated name", date: "2024-12-02T12:48:00", description: "some updated description", location: "some updated location", image: "some updated image", start_time: "15:01", end_time: "15:01", is_active: false, slug: "some updated slug"}
  @invalid_attrs %{name: nil, date: nil, description: nil, location: nil, image: nil, start_time: nil, end_time: nil, is_active: false, slug: nil}
